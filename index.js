...
const sessdata = config.SESSION_ID.replace("nathan~", '');
...
console.log('𝐍𝐚𝐭𝐡𝐚𝐧 ⸸ CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ 𝐍𝐚𝐭𝐡𝐚𝐧 ⸸ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝐍𝐚𝐭𝐡𝐚𝐧 ⸸ ✅*
...
//================ownerreact==============
if(senderNumber.includes("918438374975")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("918438374975")){
